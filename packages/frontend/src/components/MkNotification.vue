...
<div :class="$style.root">
	...
	<div :class="$style.tail">
		<header :class="$style.header">
			...
			<MkA v-else-if="['follow', 'unfollow', 'mention', 'reply', 'renote', 'quote', 'reaction', 'receiveFollowRequest', 'followRequestAccepted', 'blocked', 'unblocked'].includes(notification.type)" v-user-preview="notification.user.id" :class="$style.headerName" :to="userPage(notification.user)"><MkUserName :user="notification.user"/></MkA>
